...
colnames (mod_matrix)[1] = "lmedv" #make sure to rename it otherwise MLRwon 't find it
...
out.of.sample.rmse<- sqrt(mean((prediction$data$truth-
                                 prediction$data$response)^2))
